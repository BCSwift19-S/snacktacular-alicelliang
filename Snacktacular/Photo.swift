...
class Photo {
    ...
    func saveData(spot: Spot, completed: @escaping (Bool) -> ()) {
        ...
        documentUUID = UUID().uuidString // generate an unqiue ID to use for photo image's name
        //create a ref to upload storage to spot.docucmentID folder(bucket), with the name we created
        ...
        uploadTask.observe(.success) { (snapshot) in
            ...
            // this will either create a new doc at documentUUID or update an existing doc with that name
